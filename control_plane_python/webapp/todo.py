...
# Lack of "update" route is intentional 
# currently our clusters have no modifiable properties
# all updates to cluster state will arrive directly to Nile from the data plane. 